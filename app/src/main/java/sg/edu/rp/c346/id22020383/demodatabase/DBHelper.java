...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Task> getTasks(boolean ascendingOrder) {
        ArrayList<Task> tasks = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns = {COLUMN_ID, COLUMN_DESCRIPTION, COLUMN_DATE};
        String orderBy = COLUMN_DESCRIPTION + (ascendingOrder ? " ASC" : " DESC");
        Cursor cursor = db.query(TABLE_TASK, columns, null, null, null, null, orderBy);
